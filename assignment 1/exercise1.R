...
### QUESTION 1b
t.test(data, mu = 2800, alternative = 'g', paired = FALSE,conf.level = 0.90) # H0 : µ ??? µ0 vs H1 : µ > µ0 with alpha of 0.10
     
t.test(data, mu = 2800, alternative = 'g', paired = FALSE, conf.level = 0.95) # H0 : µ ??? µ0 vs H1 : µ > µ0 with alpha 0f 0.05
       
t.test(data, mu = 2800, alternative = 'g', paired = FALSE,  conf.level = 0.99) # H0 : µ ??? µ0 vs H1 : µ > µ0 with alpha 0f 0.01
