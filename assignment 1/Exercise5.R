...
newdt1 <- subset(chick, chick$feed == 'sunflower')
newdt2 <- subset(chick, chick$feed == 'meatmeal')
meatmeal_sunflower = rbind(newdt1, newdt2)            #create a new dataset with only 'sunflower'and 'meatmeal'
